...
import { Text, View, TouchableOpacity, Image, Share, Animated, Dimensions, Linking, ActivityIndicator } from 'react-native'
	...
	const renderItem = ({ item, index }) => {
		return (
			<TouchableOpacity activeOpacity={1} disabled={true} style={styles.card} onPress={() => console.warn("hehe")}>
				<Image resizeMode={"cover"} source={{ uri: item.image }} style={styles.cardImage} />
